  ...
  return (
    ...
    <div className="flex flex-col w-full justify-center items-center bg-slate-100">
      <div className="flex w-full h-96 mt-20 justify-center items-center bg-[url('~/images/informationPage/heroBackground.jpg')] bg-cover bg-no-repeat bg-fixed shadow-[inset_0_0_0_1000px_rgba(0,0,0,0.6)]">
        ...
        <div className="flex w-full justify-center items-center bg-slate-100">
          <div className="grid w-full grid-cols-3 mt-24 bg-[#17141f50] gap-px justify-center items-center">
            <div className="flex flex-col justify-center items-center leading-9 bg-slate-100 p-6">
